module.exports = function (app) {
  ...
  // Setup mailer
  var mailer = app.nodechat.dependencies.nodemailer.createTransport({
  			    service: app.nodechat.config.smtpService,
  			    auth: {
  			        user: app.nodechat.config.smtpUser,
  			        pass: app.nodechat.config.smtpPassword
  			    }}, function (err) {
  ...
  app.nodechat.domainServices.userService = require('../domainServices/userService')(app.nodechat.config, app.nodechat.dependencies.jwt, app.nodechat.repositories.userRepository, mailer, app.nodechat.dependencies.crypto);
